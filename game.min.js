...
Bird.prototype.init = Pipe.prototype.init = function (json) {
	for (var i in json) {
		this[i] = json[i]
	}
}
...
var Game = function () {
  ...
  this.ctx.strokeStyle = "#CE9E00";
	...
	this.spawnInterval = 90; // distanza tra i pali
	this.interval = 0;
	this.gen = [];
	this.alives = 0;
	this.generation = 0;
...
Game.prototype.update = function () {
	...
	for (var i in this.birds) {
        ...
        nextHoll
			...
			var res = this.gen[i].compute(inputs); // QUI chiede all'inteligenza dell'uccello di partorire il prossimo risultato, un valore tra 0 e 1
			if (res > 0.5) {
				this.birds[i].flap();
			}
